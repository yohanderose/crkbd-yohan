...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[0] = LAYOUT_split_3x6_3(
              ...
              LCTL_T(KC_GRV), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, SC_SENT,
                    KC_LGUI, LT(1, KC_NO), KC_SPC, KC_SPC, LT(2, KC_BSPC), RALT_T(KC_DEL)),
                                                              [1] = LAYOUT_split_3x6_3(
              KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_UNDS, KC_MINS,
              KC_TRNS, KC_APP, KC_HOME, KC_PGUP, KC_PGDN, KC_END, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_LBRC, KC_RBRC,
              KC_TRNS, KC_NO, KC_NO, KC_NO, KC_BRID, KC_BRIU, KC_MPLY, KC_MUTE, KC_VOLD, KC_VOLU, KC_BSLS, KC_TRNS,
                    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
                                                              [2] = LAYOUT_split_3x6_3(
              KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL,
              LSFT_T(KC_F1), KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,
              KC_TRNS, KC_BSPC, KC_DEL, KC_NO, RGB_VAD, RGB_VAI, KC_NO, KC_NO, KC_COMM, KC_DOT, KC_SLSH, KC_TRNS,
                    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS)};
